...
public class DeactivateAccountUseCase : IDeactivateAccountUseCase
{
    ...
    public DeactivateAccountUseCase(IAccountRepository accountRepository, IUnitOfWork unitOfWork, IAccountCacheRepository accountCacheRepository, IDomainEventDispatcher domainEventDispatcher, IAccountEventFactory accountEventFactory)
    {
    ...
    public async Task<Result> ExecuteAsync(Guid accountId, CancellationToken cancellationToken = default)
    {
        ...
        await _domainEventDispatcher.EnqueueAsync([_accountEventFactory.Deactivated(account)], cancellationToken: cancellationToken);
